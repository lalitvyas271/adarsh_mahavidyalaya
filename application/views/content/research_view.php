                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <div class="research-box1">
                                    <img src="assets/img/research/1.jpg" class="img-responsive" alt="research">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <div class="research-box1">
                                    <img src="assets/img/research/2.jpg" class="img-responsive" alt="research">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <div class="research-box1">
                                    <img src="assets/img/research/3.jpg" class="img-responsive" alt="research">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <div class="research-box1">
                                    <img src="assets/img/research/4.jpg" class="img-responsive" alt="research">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <div class="research-box1">
                                    <img src="assets/img/research/5.jpg" class="img-responsive" alt="research">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <div class="research-box1">
                                    <img src="assets/img/research/6.jpg" class="img-responsive" alt="research">
                                    <h3 class="sidebar-title"><a href="#">Robort Space Research</a></h3>
                                    <p>Bimply dummy text of the printing and typesetting istryrem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer.</p>
                                </div>
                            </div>
