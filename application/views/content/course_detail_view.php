                ...
                <div class="row">
                    <div class="col-xl-9 col-lg-9 col-md-8 col-sm-12">
                        <div class="course-details-inner">
                            <h2 class="title-default-left title-bar-high"><?php echo $c_detail->title?></h2>
                            <p><?php echo $c_detail->description?></p>
                            <img src="<?php echo $c_detail->image?>" class="img-responsive" alt="course">
                                ...
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                        <ul class="course-details-tab-btn nav" id="myTab" role="tablist">
                                            ...
                                            <li class="menu-item" role="presentation"><a class="menu-link" id="menu-3-tab" data-bs-toggle="tab" href="#menu-3" role="tab" aria-controls="menu-3" aria-selected="false">Reviews</a></li>
                                        </ul>
                                    </div>
                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                        <div class="tab-content" id="myTabContent">
                                            ...
                                            <div class="tab-pane tab-item animated fadeIn" id="menu-3" role="tabpanel" aria-labelledby="menu-1-tab">
                                                <div class="course-details-comments">
                                                    ...
                                                    <div class="media">
                                                        <a href="#" class="pull-left">
                                                            <img alt="Comments" src="assets/img/course/17.jpg" class="media-object">
                                                        </a>
                                                        <div class="media-body">
                                                    ...
                                                    <div class="media">
                                                        <a href="#" class="pull-left">
                                                            <img alt="Comments" src="assets/img/course/18.jpg" class="media-object">
                                                        </a>
                                                        <div class="media-body">
                        ...
                        <div id="shadow-carousel" class="related-courses-carousel">
                            <div class="rc-carousel" data-loop="true" data-items="3" data-margin="15" data-autoplay="false" data-autoplay-timeout="10000" data-smart-speed="2000" data-dots="false" data-nav="true" data-nav-speed="false" data-r-x-small="1" data-r-x-small-nav="true"
                                ...
                                <?php foreach($r_c_detail as $r):?>
                                <div class="courses-box1">
                                    <div class="single-item-wrapper">
                                        <div class="courses-img-wrapper hvr-bounce-to-right">
                                            <img class="img-responsive" src="<?php echo $r->image?>" alt="courses">
                                            <a href="<?php echo BASE_URL .'course/detail/'. base64_encode($r->id)?>"><i class="fa fa-link" aria-hidden="true"></i></a>
                                        </div>
                                        <div class="courses-content-wrapper">
                                            <h3 class="item-title"><a href="<?php echo BASE_URL .'course/detail/'. base64_encode($r->id)?>"><?php echo $r->title?></a></h3>
                                            <p class="item-content"><?php echo $r->description?></p>
