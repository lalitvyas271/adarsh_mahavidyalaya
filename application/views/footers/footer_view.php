...
<footer>
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                    <div class="footer-box">
                        <a href="index.html"><img style="max-width:40%" src="assets/img/logo-footer.PNG" alt="logo"></a>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                    <div class="footer-box">
                        ...
                        <ul class="corporate-address">
                            <li><i class="fa fa-phone" aria-hidden="true"></i><a href="Phone(01)800433633.html"> (+91) 9461765985 </a></li>
                            <li><i class="fa fa-envelope-o" aria-hidden="true"></i>ldspasm@gmail.com</li>
                        </ul>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12">
                    <p>&copy; <?php echo date("Y")?> Academics All Rights Reserved. &nbsp; Designed by <a target="_blank" href="https://www.radiustheme.com/" rel="nofollow"> Lalit Vyas</a></p>
                </div>
    ...
    <script src="assets/js/jquery.validationEngine.min.js" type="text/javascript"></script>
